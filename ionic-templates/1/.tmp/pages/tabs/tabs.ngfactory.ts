...
class _View_TabsPage0 extends import1.AppView<import0.TabsPage> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_2,'tabTitle','Movies Schedule');
    ...
    this.renderer.setElementAttribute(this._el_4,'tabTitle','Directors');
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_2:any = 'Movies Schedule';
