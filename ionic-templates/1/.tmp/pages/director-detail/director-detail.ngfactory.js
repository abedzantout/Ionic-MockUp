...
import * as import0 from './director-detail';
...
export var Wrapper_DirectorDetailPage = (function () {
    function Wrapper_DirectorDetailPage(p0, p1) {
        this.changed = false;
        this.context = new import0.DirectorDetailPage(p0, p1);
    }
    Wrapper_DirectorDetailPage.prototype.detectChangesInternal = function (view, el, throwOnChange) {
        var changed = this.changed;
        this.changed = false;
        return changed;
    };
    return Wrapper_DirectorDetailPage;
}());
var renderType_DirectorDetailPage_Host = null;
var _View_DirectorDetailPage_Host0 = (function (_super) {
    __extends(_View_DirectorDetailPage_Host0, _super);
    function _View_DirectorDetailPage_Host0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_DirectorDetailPage_Host0, renderType_DirectorDetailPage_Host, import6.ViewType.HOST, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_DirectorDetailPage_Host0.prototype.createInternal = function (rootSelector) {
        this._el_0 = this.selectOrCreateHostElement('page-speaker-detail', rootSelector, null);
        this._appEl_0 = new import3.AppElement(0, null, this, this._el_0);
        var compView_0 = viewFactory_DirectorDetailPage0(this.viewUtils, this.injector(0), this._appEl_0);
        this._DirectorDetailPage_0_4 = new Wrapper_DirectorDetailPage(this.parentInjector.get(import8.NavController), this.parentInjector.get(import9.NavParams));
        this._appEl_0.initComponent(this._DirectorDetailPage_0_4.context, [], compView_0);
        compView_0.create(this._DirectorDetailPage_0_4.context, this.projectableNodes, null);
        this.init([].concat([this._el_0]), [this._el_0], [], []);
        return this._appEl_0;
    };
    _View_DirectorDetailPage_Host0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
        if (((token === import0.DirectorDetailPage) && (0 === requestNodeIndex))) {
            return this._DirectorDetailPage_0_4.context;
        }
        return notFoundResult;
    };
    _View_DirectorDetailPage_Host0.prototype.detectChangesInternal = function (throwOnChange) {
        this._DirectorDetailPage_0_4.detectChangesInternal(this, this._el_0, throwOnChange);
        this.detectContentChildrenChanges(throwOnChange);
        this.detectViewChildrenChanges(throwOnChange);
    };
    return _View_DirectorDetailPage_Host0;
}(import1.AppView));
function viewFactory_DirectorDetailPage_Host0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_DirectorDetailPage_Host === null)) {
        (renderType_DirectorDetailPage_Host = viewUtils.createRenderComponentType('', 0, import10.ViewEncapsulation.None, [], {}));
    }
    return new _View_DirectorDetailPage_Host0(viewUtils, parentInjector, declarationEl);
}
export var DirectorDetailPageNgFactory = new import11.ComponentFactory('page-speaker-detail', viewFactory_DirectorDetailPage_Host0, import0.DirectorDetailPage);
var styles_DirectorDetailPage = [];
var renderType_DirectorDetailPage = null;
var _View_DirectorDetailPage0 = (function (_super) {
    __extends(_View_DirectorDetailPage0, _super);
    function _View_DirectorDetailPage0(viewUtils, parentInjector, declarationEl) {
        _super.call(this, _View_DirectorDetailPage0, renderType_DirectorDetailPage, import6.ViewType.COMPONENT, viewUtils, parentInjector, declarationEl, import7.ChangeDetectorStatus.CheckAlways);
    }
    _View_DirectorDetailPage0.prototype.createInternal = function (rootSelector) {
    ...
    _View_DirectorDetailPage0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
    ...
    _View_DirectorDetailPage0.prototype.detectChangesInternal = function (throwOnChange) {
        ...
        var currVal_2 = import4.interpolate(1, '', this.context.director.name, '');
        ...
        var currVal_4 = this.context.director.profilePic;
        ...
        var currVal_5 = this.context.director.name;
        ...
        var currVal_21 = import4.interpolate(1, '', this.context.director.about, '');
    ...
    _View_DirectorDetailPage0.prototype.destroyInternal = function () {
    ...
    return _View_DirectorDetailPage0;
}(import1.AppView));
export function viewFactory_DirectorDetailPage0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_DirectorDetailPage === null)) {
        (renderType_DirectorDetailPage = viewUtils.createRenderComponentType('', 0, import10.ViewEncapsulation.None, styles_DirectorDetailPage, {}));
    }
    return new _View_DirectorDetailPage0(viewUtils, parentInjector, declarationEl);
}
//# sourceMappingURL=director-detail.ngfactory.js.map