...
export class Wrapper_DirectorDetailPage {
  context:import0.DirectorDetailPage;
  changed:boolean;
...
var renderType_DirectorDetailPage_Host:import2.RenderComponentType = (null as any);
class _View_DirectorDetailPage_Host0 extends import1.AppView<any> {
  _el_0:any;
  /*private*/ _appEl_0:import3.AppElement;
  _DirectorDetailPage_0_4:Wrapper_DirectorDetailPage;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
    super(_View_DirectorDetailPage_Host0,renderType_DirectorDetailPage_Host,import6.ViewType.HOST,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import3.AppElement {
    this._el_0 = this.selectOrCreateHostElement('page-speaker-detail',rootSelector,(null as any));
    this._appEl_0 = new import3.AppElement(0,(null as any),this,this._el_0);
    var compView_0:any = viewFactory_DirectorDetailPage0(this.viewUtils,this.injector(0),this._appEl_0);
    ...
    this._appEl_0.initComponent(this._DirectorDetailPage_0_4.context,([] as any[]),compView_0);
    compView_0.create(this._DirectorDetailPage_0_4.context,this.projectableNodes,(null as any));
    this.init(([] as any[]).concat([this._el_0]),[this._el_0],([] as any[]),([] as any[]));
    return this._appEl_0;
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.DirectorDetailPage) && (0 === requestNodeIndex))) { return this._DirectorDetailPage_0_4.context; }
...
function viewFactory_DirectorDetailPage_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<any> {
  if ((renderType_DirectorDetailPage_Host === (null as any))) { (renderType_DirectorDetailPage_Host = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,([] as any[]),{})); }
  return new _View_DirectorDetailPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const DirectorDetailPageNgFactory:import11.ComponentFactory<import0.DirectorDetailPage> = new import11.ComponentFactory<import0.DirectorDetailPage>('page-speaker-detail',viewFactory_DirectorDetailPage_Host0,import0.DirectorDetailPage);
const styles_DirectorDetailPage:any[] = ([] as any[]);
var renderType_DirectorDetailPage:import2.RenderComponentType = (null as any);
class _View_DirectorDetailPage0 extends import1.AppView<import0.DirectorDetailPage> {
  _el_0:any;
  ...
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
    super(_View_DirectorDetailPage0,renderType_DirectorDetailPage,import6.ViewType.COMPONENT,viewUtils,parentInjector,declarationEl,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import3.AppElement {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_2:any = import4.interpolate(1,'',this.context.director.name,'');
    ...
    const currVal_4:any = this.context.director.profilePic;
    ...
    const currVal_5:any = this.context.director.name;
    ...
    const currVal_21:any = import4.interpolate(1,'',this.context.director.about,'');
...
export function viewFactory_DirectorDetailPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement):import1.AppView<import0.DirectorDetailPage> {
  if ((renderType_DirectorDetailPage === (null as any))) { (renderType_DirectorDetailPage = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,styles_DirectorDetailPage,{})); }
