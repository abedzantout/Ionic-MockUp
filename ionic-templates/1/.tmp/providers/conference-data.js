...
export var ConferenceData = (function () {
    ...
    ConferenceData.prototype.processSession = function (data, session) {
        ...
        session.directors = [];
        if (session.directorNames) {
            session.directorNames.forEach(function (directorName) {
                var director = data.directors.find(function (s) { return s.name === directorName; });
                if (director) {
                    session.directors.push(director);
                    director.sessions = director.sessions || [];
                    director.sessions.push(session);
                }
            });
        }
        if (session.tracks) {
    ...
    ConferenceData.prototype.getDirectors = function () {
        return this.load().then(function (data) {
            return data.directors.sort(function (a, b) {
    ...
    ConferenceData.prototype.getSlide = function () {
        return this.load().then(function (data) {
            return data.slides;
        });
    };
